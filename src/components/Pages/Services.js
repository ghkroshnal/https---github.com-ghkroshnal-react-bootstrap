...
import coding from '../../Assests/images/services';
      ...
      <div className="container px-4 py-5" id="custom-cards">
          <h2 className="pb-2 border-bottom">Custom cards</h2>
            ...
            <div className="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
              <div className="col">
                <div className="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style={{backgroundImage: 'coding.jpg'}}>
                  <div className="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                    ...
                    <ul className="d-flex list-unstyled mt-auto">
                      ...
                      <li className="d-flex align-items-center me-3">
                        <FontAwesomeIcon icon={faGlobe} classNameName="me-2" />
                        <small>Earth</small>
                      </li>
